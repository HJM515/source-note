...
export default {
  ...
  props: {
    ...
    property: String, // 功能同prop
    prop: String,
    width: {},
    minWidth: {},
    renderHeader: Function,
    sortable: { // 'custom' 远程排序，需要监听sort-change事件
      type: [Boolean, String],
      default: false
    },
    sortMethod: Function, //返回数字，类似Array.sort
    sortBy: [String, Function, Array],
    resizable: {
      type: Boolean,
      default: true
    },
    columnKey: String, //filter-change事件需要
    align: String, // 对齐方式
    headerAlign: String, // 表头对齐方式 table没有这两个属性
